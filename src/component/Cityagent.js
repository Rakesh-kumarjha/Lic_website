...
const Cityagent = () => {
  return (
    <div>
      <div className='city'>
      <h1><b>City Career Agent</b></h1>
      </div>
      <img className="mt-2" src={img1}/>
      <div class="container mx-auto p-4 rounded-lg">
      
        <h1 class="text-3xl font-bold mb-4">LIC City Career Agent</h1><br></br>
        <p class="text-gray-600">Usually LIC agent works on commission basis which depends on the premium and Policy Term of LIC policy. As a part time job you can earn huge as commission and also a Fixed income is great option.</p><br></br>
        <p class="text-gray-600">LIC has introduced New LIC AGENT Recruitment scheme in Urban area of country in the form of CITY Career Agent. Now Newly Recruited LIC agent will get monthly remuneration as well as commission also.</p><br></br>
        <p class="text-gray-600">If you want to become LIC agent or you are interested to make career in LIC then it’s a great opportunity for you.</p><br></br>
        <h1 class="text-2xl font-bold mb-4">Who can be City Career Agent in LIC of India?
        </h1><br></br>
        <ul>
        <li>Housewife,Who want to be self dependent on earning.</li>
        <li>Employed, who have few spear time to work.</li>
        <li>Retired or VRSopted person for any organisation</li>
      ...
      <h1 class="text-2xl  mb-4">What is Eligibility to be City Career Agent in LIC?
       ...
       <h1 class="text-2xl  mb-4">What is selection Procedure to be City Career Agent?
        </h1>
        <ul>
        ...
        <h1 class="text-2xl  mb-4">Required documents needed to be City Career Agent?
        </h1>
        <ul>
        ...
        <h1 class="text-3xl  mb-4">What is Minimum Business required Target for City Career Agent?</h1>
